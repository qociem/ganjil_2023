...
; 0000 002B DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(7)
	OUT  0x4,R30
; 0000 002C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=1 Bit1=1 Bit0=1
; 0000 002D PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	OUT  0x5,R30
; 0000 002E 
...
; 0000 009D PORTB.0 = 0;  //segA1
	RCALL SUBOPT_0x0
; 0000 009E PORTB.1 = 1;
; 0000 009F PORTB.1 = 0;
; 0000 00A0 PORTB.0 = 0;  //segA2
; 0000 00A1 PORTB.1 = 1;
; 0000 00A2 PORTB.1 = 0;
; 0000 00A3 PORTB.0 = 0;  //segB
; 0000 00A4 PORTB.1 = 1;
; 0000 00A5 PORTB.1 = 0;
; 0000 00A6 PORTB.0 = 0;  //segC
	RCALL SUBOPT_0x0
; 0000 00A7 PORTB.1 = 1;
; 0000 00A8 PORTB.1 = 0;
; 0000 00A9 PORTB.0 = 0;  //segD2
; 0000 00AA PORTB.1 = 1;
; 0000 00AB PORTB.1 = 0;
; 0000 00AC PORTB.0 = 0;  //segD1
; 0000 00AD PORTB.1 = 1;
; 0000 00AE PORTB.1 = 0;
; 0000 00AF PORTB.0 = 1;  //segE
	SBI  0x5,0
; 0000 00B0 PORTB.1 = 1;
	RCALL SUBOPT_0x1
; 0000 00B1 PORTB.1 = 0;
; 0000 00B2 PORTB.0 = 1;  //segF
; 0000 00B3 PORTB.1 = 1;
; 0000 00B4 PORTB.1 = 0;
; 0000 00B5 PORTB.0 = 0;  //segH
; 0000 00B6 PORTB.1 = 1;
; 0000 00B7 PORTB.1 = 0;
; 0000 00B8 PORTB.0 = 0;  //segJ
	CBI  0x5,0
; 0000 00B9 PORTB.1 = 1;
	RCALL SUBOPT_0x1
; 0000 00BA PORTB.1 = 0;
; 0000 00BB PORTB.0 = 1;  //segK
; 0000 00BC PORTB.1 = 1;
; 0000 00BD PORTB.1 = 0;
; 0000 00BE PORTB.0 = 0;  //segG2
; 0000 00BF PORTB.1 = 1;
; 0000 00C0 PORTB.1 = 0;
; 0000 00C1 PORTB.0 = 1;  //segL
	SBI  0x5,0
; 0000 00C2 PORTB.1 = 1;
	SBI  0x5,1
; 0000 00C3 PORTB.1 = 0;
	CBI  0x5,1
; 0000 00C4 PORTB.0 = 0;  //segM
	CBI  0x5,0
; 0000 00C5 PORTB.1 = 1;
	SBI  0x5,1
; 0000 00C6 PORTB.1 = 0;
	CBI  0x5,1
; 0000 00C7 PORTB.0 = 0;  //segN
	CBI  0x5,0
; 0000 00C8 PORTB.1 = 1;
	SBI  0x5,1
; 0000 00C9 PORTB.1 = 0;
	CBI  0x5,1
; 0000 00CA PORTB.0 = 1;  //segG1
	SBI  0x5,0
; 0000 00CB PORTB.1 = 1;
	SBI  0x5,1
; 0000 00CC PORTB.1 = 0;
